    ...
    <>
      ...
      <ArticleList order>
        ...
        <li>
          ...
          zapisać dziecko do chrztu św., ale za pisemną zgodą swojego proboszcza
        </li>
        <li>
          Rodzice chrzestni spoza naszej parafii powinni posiadać zaświadczenie
          od proboszcza własnej parafii, zawierające informację, że są
      ...
      <p className="text-left text-xl">
        Pierwszym i najważniejszym obowiązkiem chrzestnego jest pomoc rodzicom w
        chrześcijańskim wychowaniu swojego dziecka. Dlatego też Kościół, w
      ...
      <ArticleList order>
        ...
        <li>
          ...
          Eucharystiioraz prowadzi życie zgodne z wiarą i odpowiadające funkcji,
          jaką ma pełnić.
        </li>
